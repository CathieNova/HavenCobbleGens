...
{
    public CobbleGenUpgradeWooden(Properties properties)
    {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context)
    {
        ...
        if (context.getLevel().getBlockState(context.getClickedPos()).getBlock() == ModBlocks.wooden_cobble_gen.get()
                && context.getLevel().getBlockEntity(context.getClickedPos()) instanceof CobbleGenEntity cobbleGen
                && cobbleGen.upgradeTo(ModBlocks.stone_cobble_gen.get()))
        {
